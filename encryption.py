...
SENSITIVE_FIELDS = {
    'user_level_en': ['email'],
    'receipt_usage_quota_receipt_en': ['email'],
    'receipt_usage_quota_request_en': ['email'],
    'contact': ["email", "first_name", "last_name", "message"],
    'enterprise_contact': ["email", "company_name", "industry", "message"]
}
